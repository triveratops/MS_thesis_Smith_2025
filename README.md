...
**Geochemistry of the Black Mtn. Gravity Slide** -> files contain all of the major and minor oxide geochemistry in weight percent. Analyses performed using XRF. Trace elements are reported in ppm, and they were analyzed using LA-ICP-MS.
- [Major Element Geochemistry](/geochemistry/major_elements.csv)
- [Minor and Trace Element Geochemistry](/geochemistry/trace_elements.csv)
